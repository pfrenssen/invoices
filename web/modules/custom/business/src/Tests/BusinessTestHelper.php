...
trait BusinessTestHelper {
  ...
  public function convertBusinessValuesToFormPostValues(array $values) : array {
    ...
    return [
      ...
      'field_business_address[0][address][country_code]' => 'BE',
      'field_business_address[0][address][address_line1]' => $values['field_business_address']['address_line1'],
      'field_business_address[0][address][postal_code]' => $values['field_business_address']['postal_code'],
      'field_business_address[0][address][locality]' => $values['field_business_address']['locality'],
